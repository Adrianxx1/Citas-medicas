package com.adrian.pacientes.entities;

import com.adrian.commons.utils.StringCustomUtils;
import com.adrian.commons.utils.ValoresNumericosUtils;
...
public class Paciente {
    ...
    private void validarNoEliminado() {
        if (this.estadoRegistro == EstadoRegistro.ELIMINADO)
            throw new IllegalStateException("El paciente está eliminado");
    }

    private static void validarDatos(String nombre, String apellidoPaterno, String apellidoMaterno, String email,
        ...
        ValoresNumericosUtils.validarRangoShort(edad, (short) 1, (short) 100, "La edad es requerida");
        ValoresNumericosUtils.validarRangoDouble(peso, 0.1, 200.0, "El peso es requerido");
        ValoresNumericosUtils.validarRangoDouble(estatura, 1.0, 2.0, "La estatura es requerida");
    }
}