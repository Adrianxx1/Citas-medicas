...
public record PacienteRequest(
        ...
        @DecimalMin(value = "1.0", message = "El peso debe ser mayor que 0kg")
        @DecimalMax(value = "200", message = "El peso máximo permitido es de 200 kg")
        Double peso,

        @NotNull(message = "La estatura es requerida")
        @DecimalMin(value = "1.0", message = "La estatura mínima es de 1.0 m")
        @DecimalMax(value = "2.0", message = "La estatura máxima es de 2.0 m")
        Double estatura,
